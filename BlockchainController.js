...
class BlockchainController {
    ...
    // Enpoint to Get all Blocks (GET Endpoint)
    getBlocks() {
        this.app.get("/blocks", async (req, res) => {
            let chain = await this.blockchain.getBlocks();
    ...
    // This endpoint allows you to request the check if the chain is broken or not.
    validateChain() {
